...
public class Record {
  ...
  public static void addArray(String key, Object[] values) {
  ...
  public static void begin(String key) { add(key); indent++; }
  public static void begin(String key, Object val) { add(key, val); indent++; }
  public static void end() { indent--; }
